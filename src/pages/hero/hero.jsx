        ...
        <section id="hero" ref={container}>
           { navActive? (<div id='navMobile' onClick={toggleMobileNav} ref={ref} >
            ...
            <nav id='navbar'>
                    ...
                    <h1 id='navCenter'> creative territory</h1>
            ...
            <div id='heroOther'>
                <p><span id='txtG'>The creative territory</span><span className='hIc'><img src='profile.png' /></span> 
                we provide exceptional photography and videography services,we are based in enugu state nigeria...
                </p>
